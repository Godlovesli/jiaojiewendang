...
class MyTest(unittest.TestCase):
    ...
    def setUp(self):
        # self.base_url = 'http://10.0.10.100:17201'                  # 电压力锅插件测试环境
        # self.base_url = 'http://pre-pressureplugapi.joyami.com'       #电压力锅预生产环境
        self.base_url = 'https://pressureplugapi.joyami.com'
        # self.base_url='http://116.247.124.138:8080'
