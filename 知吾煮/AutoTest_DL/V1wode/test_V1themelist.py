...
class v1minethemelistTest(MyTest):
    '''发布的话题列表'''
    url_path = '/v1/mine/theme/list'

    @classmethod
    def setUpClass(cls):
        pass

    def test_themelist_success(self):
        '''所有参数都传'''
    ...
    def test_themelist_success1(self):
        '''所有参数都不传'''
        token = Login().login()  # 引用登录
        params = ''
        print params
    ...
    def test_themelist_tokenerror(self):
        '''token错误'''
        token = Login().login()  # 引用登录
        params = ''
        print params
    ...
    def test_themelist_tokenull(self):
        '''未传入token'''
        params = ''
        print params
        r = self.myhttp1('GET',
    ...
    def test_themelist_signerror(self):
        '''sign不正确'''
    ...
    def test_themelist_noncerror(self):
        '''nonce不正确'''
        self.token = Login().login()  # 引用登录
        print self.token
        params = {'pageno': '1','perpage':'20'}
