...
class checknewTest(MyTest):
    ...
    def test_checknew_success(self):
    ...
    def test_checknew_repanull(self):
    ...
    def test_checknew_signerror(self):
        '''sign不正确'''
        params = {'release_code': '256'}
        print params
    ...
    def test_checknew_noncerror(self):
        '''nonce不正确'''
        params = {'release_code': '256'}
        print params
