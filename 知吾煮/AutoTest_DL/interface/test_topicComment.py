...
class topiccommitCommentTest(MyTest):
    '''话题评论'''
    url_path = '/topic/comment/commitComment'
    ...
    def test_topiccomment_success(self):
        ...
        if data_count > 0:
            ...
            r = self.myhttp('POST',
                            self.url_path,
                            params,
                            # {'topicId': topicId, 'parentId':parentId, 'content': 'test'},
                            token
                            )
            print r
            js = json.loads(r)
    ...
    def test_topiccomment_signerror(self):
        ...
        # params = urllib.urlencode({'topicId': 6, 'content': 'hao'})
