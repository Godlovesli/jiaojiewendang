...
class ricecollectaddTest(MyTest):
    '''添加收藏记录'''
    url_path = '/ricecollect/add'

    @classmethod
    def setUpClass(cls):
        pass

    def test_ricecollectadd_success(self):
        '''所有参数都传,添加成功'''
    ...
    def test_ricecollectadd_rino(self):
        '''米ID不存在'''
        ...
        js = json.loads(r)
        self.assertEqual(js['state'], -1)
        self.assertIn("加入用户收藏列表出现错误", js['message'])


    def test_ricecollectadd_deno(self):
        '''设备ID不存在'''
    ...
    def test_ricecollectadd_delose(self):
        '''deviceid未传'''
        params = 'riceid=1558'
        r = self.myhttp('POST',
                        self.url_path,
    ...
    def test_ricecollectadd_denull(self):
        '''deviceid的值为空'''
    ...
    def test_ricecollectadd_depanull(self):
        '''deviceid为空'''
    ...
    def test_ricecollectadd_rilose(self):
        '''riceid未传'''
    ...
    def test_ricecollectadd_rinull(self):
        '''riceid的值为空'''
    ...
    def test_ricecollectadd_ripanull(self):
        '''riceid为空'''
    ...
    def test_ricecollectadd_signerror(self):
        '''sign不正确'''
        params = {'deviceid':'1128170','riceid':'1558'}
        print params
    ...
    def test_ricecollectadd_noncerror(self):
        '''sign不正确'''
        params = {'deviceid':'1128170','riceid':'1558'}
        print params
