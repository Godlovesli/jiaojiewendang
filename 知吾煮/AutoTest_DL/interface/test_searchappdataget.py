...
class searchappdataget1Test(MyTest):
    '''搜索/筛选接口'''
    ...
    def test_searchappdataget_success(self):
        '''传入所有参数'''
        params = 'content=&dmgs=1&pageno=1&perpage=50&recipetype=1,2'
        r = self.myhttp('GET',
                        self.url_path,
                        params,
                         )
...
class searchappdatagetTest(MyTest):
    ...
    def test_searchappdataget_success(self):
        '''传入所有参数'''
        params = 'content=&deviceModel=chunmi.cooker.press1&pageno=1&perpage=50&recipetype=4'
        r = self.myhttp('GET',
                        self.url_path,
                        params,
                         )
